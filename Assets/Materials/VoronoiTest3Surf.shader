Shader "Custom/VoronoiTest3Surf"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			float divFactor = 0;
			float2 dir;
			VoronoiImg = 1 - saturate(VoronoiWithDir(_CellDensity, IN.worldPos.xy, newRadius, dir));
			VoronoiImg = 1 - VoronoiImg * VoronoiImg;
			...
			o.Normal = normalize(float3(-dir * _NormalHeight * VoronoiImg, 1));
